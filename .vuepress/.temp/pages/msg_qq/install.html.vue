...
<h3 id="nonebot" tabindex="-1"><a class="header-anchor" href="#nonebot" aria-hidden="true">#</a> NoneBot</h3>
<ul>
<li>下载 <code v-pre>nonebot-plugin-guild-patch</code>、<code v-pre>nonebot_plugin_msgqq</code> 到 <code v-pre>plugins</code> 文件夹</li>
<li>下载 <strong>/</strong> 新建 <code v-pre>msg_qq_config.py</code> 配置文件到 <code v-pre>src</code> 目录下</li>
</ul>
...
├── 📜 pyproject.toml
└── 📜 README.md
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="minecraft-server" tabindex="-1"><a class="header-anchor" href="#minecraft-server" aria-hidden="true">#</a> Minecraft Server</h3>
<ul>
<li>将 <code v-pre>Msg_QQ.jar</code> 放入 <code v-pre>Minecraft</code> 服务器 <code v-pre>plugins</code> 文件夹</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="完成" tabindex="-1"><a class="header-anchor" href="#完成" aria-hidden="true">#</a> 完成</h2>
